# Vendored from PyTorch Geometric 2.7.x (Polynormer attention).
# SPDX: PyG uses MIT License — see upstream: https://github.com/pyg-team/pytorch_geometric
# Source reference: torch_geometric/nn/attention/polynormer.py
...
register_layer('polynormer_attention', PolynormerAttention)
